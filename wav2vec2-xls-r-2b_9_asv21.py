...
def main(outdir, indir, metadata_file):
    ...
    np.save(
        os.path.join(outdir, f"wav2vec2-xls-r-2b_Layer9_asv21.npy"),
        stacked_embeddings,
    )
...
if __name__ == "__main__":
    ...
    indir = "/netscratch/fkallel/DATA/ASVspoof2021_DF_eval/flac"
    ...
    metadata_file = "./processed_metadata/asv21_systems.csv"
