...
def main(outdir, indir, metadata_file, batch_size=8, num_workers=4):
    ...
    np.save(
        os.path.join(outdir, "wav2vec2-xls-r-2b_Layer9_mlaad.npy"),
        stacked_embeddings,
    )
...
if __name__ == "__main__":
    ...
    metadata_file = "./processed_metadata/mlaad_v5_xls_systems.csv"
    main(outdir, indir, metadata_file, batch_size=2, num_workers=2)
