...
def main(outdir, indir, metadata_file):
    ...
    np.save(
        os.path.join(outdir, f"wav2vec2-xls-r-2b_Layer9_itw.npy"),
        stacked_embeddings,
    )
...
if __name__ == "__main__":
    ...
    indir = "/netscratch/fkallel/DATA/release_in_the_wild/"
    ...
    metadata_file = "./processed_metadata/itw_systems.csv"
