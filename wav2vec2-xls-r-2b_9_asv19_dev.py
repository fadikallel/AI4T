...
def main(outdir, indir, metadata_file):
    ...
    np.save(
        os.path.join(outdir, f"wav2vec2-xls-r-2b_Layer9_asv19_dev.npy"),
        stacked_embeddings,
    )
...
if __name__ == "__main__":
    ...
    indir = "/ds-slt/audio/ASVSpoof_LA_19/ASVspoof2019_LA_dev/flac/"
    ...
    metadata_file = "./processed_metadata/asv19_dev_systems.csv"
